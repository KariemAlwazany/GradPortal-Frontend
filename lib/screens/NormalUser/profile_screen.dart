...
Future<Map<String, dynamic>?> getUser() async {
  ...
  final response = await http.get(
    Uri.parse('http://192.168.88.6:3000/GP/v1/users/me'),
    headers: {
  ...
  void _saveProfile() async {
    ...
    if (!_oldPasswordController.text.isEmpty) {
      response = await http.patch(
          Uri.parse('http://192.168.88.6:3000/GP/v1/users/updatePassword'),
          headers: {
            'Content-Type': 'application/json',
            'Authorization': 'Bearer $token',
          },
      ...
      if (!_fullNameController.text.isEmpty && _emailController.text.isEmpty) {
        final response2 = await http.patch(
            Uri.parse('http://192.168.88.6:3000/GP/v1/users/updateMe'),
            headers: {
              'Content-Type': 'application/json',
              'Authorization': 'Bearer $token',
            },
