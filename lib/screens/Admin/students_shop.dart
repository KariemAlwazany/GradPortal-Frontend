...
class StudentsShop extends StatefulWidget {
  const StudentsShop({super.key});

  @override
  _StudentsShopState createState() => _StudentsShopState();
}

class _StudentsShopState extends State<StudentsShop> {
  ...
  Future<void> fetchStudentRequests() async {
    ...
    final response = await http.get(
      Uri.parse('${dotenv.env['API_BASE_URL']}/GP/v1/admin/students'),
      headers: {
