...
class DoctorRequestsPage extends StatelessWidget {
  final List<Map<String, String>> doctorRequests = [
    {
      'name': 'Dr. Alice Johnson',
      'details': 'Request to join department',
      'image': 'assets/doctor_degree1.png'
    },
    {
      'name': 'Dr. Bob Brown',
      'details': 'Request for project assignment',
      'image': 'assets/doctor_degree2.png'
    },
  ];
